...
(yit, pension, α, β, β_k) = incomeDistribution(agents, bs, μₐ, μᵦ, var_α, var_β,
                                             cov_αβ, var_ɛ, var_η, ρ, y_adj, tW)

# 2. Construct individual specific belief histories
(s_f_i, stdy, k) =
  learning(α, β, β_k, yit, ρ, var_α, var_β, cov_αβ, var_η, var_ɛ, fpu)

# 3. Construct Grids
(xgrid, agrid, bgrid, zgrid, wgrid_R, ygrid_R) =
  grids(s_f_i, stdy, wpoints, apoints, bpoints, zpoints, wpoints_R, ypoints_R,
  wmaxR, power, r,tR, true)
