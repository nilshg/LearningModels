...
(wgrid, agrid, bgrid, zgrid, wgrid_R, ygrid_R) =
  grids(s_f_i, stdy, agents, bs, power, wpoints, apoints, bpoints, zpoints,
        wpoints_R, ypoints_R, wmaxR, r, tW, tR, false, true)

# 4. Solve Retirement Problem
(v_R, wp_R) =
  solveRetirement(wgrid_R, ygrid_R, wpoints_R, ypoints_R, r, δ, tR)
